    ...
    public partial class dashboard : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["filter"] != null)
            {
                ...
                else if (Request.QueryString["filter"] == "Deliverd")
                {
                    lblFilterTitle.Text = "Deliverd Orders";
                    displayOrdersTable("SELECT * FROM Orders WHERE order_status = 'Deliverd' AND order_user = '" + userid + "'");
                }
                else
                {
