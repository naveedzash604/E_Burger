            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="titlepage">
                        ...
                        <a class="text-danger" href='userprofile.aspx?userid=<%:Session["userid"]%>' class="btn-link"> View My Account</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <h1><asp:Label ID="lblFilterTitle" runat="server" Text="All Orders"></asp:Label> </h1>
           <div class="row mt-3">
               ...
               <a class="btn btn-primary mb-5 ml-2" href="dashboard.aspx?filter=approved">
                   Delivered Orders (<asp:Label ID="lblApprovedOrders" runat="server" Text="0"></asp:Label>)
               </a>
